...
def get_relation_constraints() -> List[BaseRelationConstraint]:
    ...
    g1 = (Feature("installment") - installment <= Constant(0.01)) & (
...
def create_dataset(cdgm: bool,
    ...
    data_source = DownloadFileDataSource(
        url="",
        file_data_source=CsvDataSource(path="./data/mlc/lcld/lcld.csv"),
    )
    metadata_source = DownloadFileDataSource(
        url="",
        file_data_source=CsvDataSource(
            path="./data/mlc/lcld/lcld_metadata.csv"
        ),
    )
    ...
    if date_1317:
        ...
        data_source = DownloadFileDataSource(
            ...
            file_data_source=CsvDataSource(
                path="./data/mlc/lcld_201317/lcld_201317.csv"
            ),
        )
        metadata_source = DownloadFileDataSource(
            url="https://uniluxembourg-my.sharepoint.com/:x:/g/personal/"
        ...
        if simulate_date:
            ...
            data_source = DownloadFileDataSource(
                ...
                file_data_source=CsvDataSource(
                    path="./data/mlc/lcld_201317_ds/lcld_201317_ds.csv"
                ),
            )
            metadata_source = DownloadFileDataSource(
                url="https://uniluxembourg-my.sharepoint.com/:x:/g/personal/"
...
datasets = [
    {
        "name": "lcld_cdgm",
        "fun_create": lambda: create_dataset(True, False, False, False),
    },
    {
        "name": "lcld_iid",
        "fun_create": lambda: create_dataset(False, False, False, False),
    },
    {
        "name": "lcld_v2_iid",
        "fun_create": lambda: create_dataset(False, False, False, False),
    ...
    {
        "name": "lcld_time",
        "fun_create": lambda: create_dataset(False, True, False, False),
    },
    {
        "name": "lcld_v2_time",
        "fun_create": lambda: create_dataset(False, True, False, False),
    ...
    {
        "name": "lcld_201317_time",
        "fun_create": lambda: create_dataset(False, True, True, False),
    },
    {
        "name": "lcld_201317_ds_time",
        "fun_create": lambda: create_dataset(False, True, True, True),
    },
]
