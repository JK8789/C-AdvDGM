...
def cross_validation(model, X, y, metric, args, n_jobs=1):
    ...
    #     sce = create_metric("precision")
    #     metric_val = compute_metric(curr_model, sce, X_test, y_test)
    #     experiment.log_metric("test_{}".format(sce.metric_name), metric_val)
    #     print("test_{}".format(sce.metric_name))
    #     print(f"Precision {metric_val}")

    #     sce = create_metric("recall")
    #     metric_val = compute_metric(curr_model, sce, X_test, y_test)
    #     experiment.log_metric("test_{}".format(sce.metric_name), metric_val)
    #     print(f"Recall {metric_val}")
    #     experiment.end()
