...
from mlc.constraints.backend import Backend
    ...
    def visit(self, constraint_node: ConstraintsNode) -> Any:
        ...
        if isinstance(constraint_node, Constant):
            ...
            if isinstance(self.backend, PytorchBackend) and all(
                ...
                feature_ids = [get_feature_index(self.feature_names, f) for f in feature_ids]
        ...
        # ------ Comparison
            ...
            if constraint_node.tolerance is not None:
                ...
                tolerance = None
            return self.backend.equal_constraint(left_operand, right_operand, tolerance)
