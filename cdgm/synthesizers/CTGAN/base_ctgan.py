...
class BaseSynthesizer:
    ...
    def __getstate__(self):
        ...
        if (
            ...
            ## Updating this manually due to pickling issues
            state['_numpy_random_state'] = 7
            state['_torch_random_state'] = 7
    ...
    def __setstate__(self, state):
        ...
        if '_numpy_random_state' in state and '_torch_random_state' in state:
            ...
            state['random_states'] = (
                 np.random.RandomState(seed=np_state),
                 torch.Generator().manual_seed(torch_state),
            )
